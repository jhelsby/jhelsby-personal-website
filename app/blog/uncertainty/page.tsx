...
const body = <div>
  ...
  <h3>Business</h3>
  <p>I&apos;ve not read many straight business books, but found those that I have to be extremely insightful, and (unsurprisingly) in a totally different way to the above subjects. The importance of vision, belief, drive, and execution when dealing with uncertainty is emphasised infinitely more often &ndash; although I have no doubt that these are mandatory qualities for great scientists and engineers, too.</p>
