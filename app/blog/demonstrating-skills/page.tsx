...
const body = <div>
    <p>
        How can you demonstrate both technical skills and business understanding through your coding projects? Someone asked me a question in this area &ndash; here is an adaptation of a very quick reply I gave. I may try to rewrite this into a more developed post in future, but for now it is extremely rough! I&apos;m trying to avoid points which I discussed in my <a href="internships">Internships</a> post, which was primarily about application processes. Instead, I&apos;ll be focusing on skills I think can help while actually working as a software engineer.
    </p>
    ...
    <p>
        For business needs, it&apos;s to try and good to understand why companies pursue certain projects and not others, where the money is being made, etc. Alongside customer thinking, mentioned above, I&apos;d also try to quantify aspects of your projects if possible. For example, "Achieved 5000 downloads in 3 months", "Cut launch time by 35% by [doing some optimisation]", or "Maintained minimum unit test coverage of 80%".
    </p>
    <p>
