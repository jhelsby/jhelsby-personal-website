...
const body = <div>
    ...
    <p>
        I think it could be a good idea to get to grips with a single programming language to begin with. Doing so will also allow you to learn the basics of programming in general. Python, Java, C, or C++ could be a good place to start, among others, as they are very widely used. As per the &quot;Finding Resources&quot; section above, I don&apos;t want to make any specific recommendations about which to go for &ndash; it might be useful to do some research yourself and figure out where you&apos;d like to start. If you&apos;re undecided, though, I would perhaps suggest this <a href="https://www.python.org/about/gettingstarted/">Python for Beginners</a> guide from the official Python documentation.
    </p>
    <p>
