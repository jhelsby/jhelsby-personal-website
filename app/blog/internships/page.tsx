...
const body = <div>
    <p>I&apos;m very fortunate to be undertaking a Software Development Engineer internship at Amazon London at the time of writing. Since I started, a few people have asked me if I have any tips on how they might secure a similar role. I don&apos;t know how qualified I am to answer such a question, but would like to help if I can.</p>
    ...
    <h3>Meta (January 2025 update)</h3>
    <p>I recently accepted an offer to join Meta London for a Software Engineering internship this summer, for which I feel hugely fortunate. I wanted to note that the points discussed above all helped me with my Meta application process too. For the technical interview portion, I would add just a couple of points.</p>
    <p>Firstly, the preparation resources Meta provided quite early on in the application process were very good and comprehensive &ndash; they even provide a public guide <a href="https://www.metacareers.com/swe-prep-techscreen/">here</a>. Secondly, as the public guide mentions, you&apos;ll be asked to solve one or two problems in under 35 minutes, so it might be worth practicing under time constraints.</p>
