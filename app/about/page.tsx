  ...
  return (
    <div id="outer-container">
      ...
      <div id="page-wrap">
        ...
        <p>I&apos;m John Lu Helsby, a software engineer with a passion for technology and innovation as a force for good. I&apos;m particularly interested in scalable systems, distributed computing, artificial intelligence, and how these tools can be applied to benefit ordinary people the world over.</p>
