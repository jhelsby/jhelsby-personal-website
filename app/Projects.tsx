...
const LoxInterpreters: ProjectFunction = () => {
  return {
    ...
    description: <p>
      <i>jlox</i> and Lox are described in <a href="https://craftinginterpreters.com/">Crafting Interpreters</a> (2021), by Robert Nystrom.Lox is a simple, dynamically typed, object - oriented language.Once I complete these notes, I plan to implement my own interpreter based on < i > clox</i >, the book & apos;s more efficient C - based interpreter.
    </p >,
