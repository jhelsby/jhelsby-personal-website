...
const Conduit: ProjectFunction = () => {
  return {
    ...
    description: (
      <div>
        <p>Conduit is an LLM-based text editor with an intuitive graphical interface. It allows you to employ ChatGPT, Claude, Gemini and other LLMs as AI writing assistants, without having to type in any prompts. Please expand the details tab below for some demo images, a brief scenario walkthrough, and some technical implementation. A demo video is coming soon!</p>
