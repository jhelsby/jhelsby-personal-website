...
const DictionWave: ProjectFunction = () => {
  return {
    ...
    details: <div>
      ...
      <p>The fastText database used - crawl-300d-2M.vec - contains two million unique words taken from Common Crawl data; 630 billion words obtained from crawling the web. Many of these are data irrelevant or harmful to this use case, such as numbers, misspellings, duplicates, and obscene or derogatory language. I implemented a number of automated processes alongside manual cleaning to remove as many of these words as possible &ndash; 798,528 at the last count (40%). The code handling this can be found in <a href="https://github.com/jhelsby/DictionWave/blob/main/filter_embeddings.py">filter_embeddings.py</a>. I hope to reduce this dataset further using NLP techniques, as a cleaner dataset would improve speed, memory consumption, and output quality.</p>
