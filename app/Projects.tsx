...
const Conduit: ProjectFunction = () => {
  return {
    ...
    description: (
      <div>
        <p>Conduit is an LLM-based text editor with an intuitive graphical interface. It allows you to employ ChatGPT, Claude, Gemini and other LLMs as AI writing assistants, without having to type in any prompts. Please expand the details tab below for some demo images, a brief scenario walkthrough, and some technical implementation. A demo video and an interactive demo are coming soon!</p>
        <p>Please note that Conduit is currently in development, so new features will be added over time. In particular, we hope to make Conduit publicly available as soon as possible, so you can try it out yourselves.</p>
    ...
    details: (
      <div>
        ...
        <p>In this example, we clicked "Summarise". This sends a prompt to our LLM, asking for a summary of the selected paragraph. Conduit delivers you the result:</p>
        <Image
