...
const Conduit: ProjectFunction = () => {
  return {
    ...
    description: (
      <div>
        <p>Conduit is an LLM-based text editor with an intuitive graphical interface. It allows you to employ ChatGPT, Claude, Gemini and other LLMs as AI writing assistants, without having to type in any prompts. Please expand the Details tab below for some demo images, and a brief scenario walkthrough. A demo video and an interactive demo are coming soon!</p>
