    ...
    <div id="outer-container">
      ...
      <div id="page-wrap">
        ...
        <div className="photo-container">
          ...
          />
          <div>
            <p>Welcome to my coding website! I&apos;m John Helsby, a software engineer and a final-year Computer Science & Mathematics BSc (Hons) student at the University of Bath, United Kingdom. I previously undertook Software Engineering internships at Meta, Amazon, AWS, and Wolfram Research.</p>
        ...
        <div>
          ...
          <div>
            <ul>
              ...
              <li><a href="/blog">My Technical Blog</a>.</li>
          ...
          <p> Thank you for reading &ndash; and please don&apos;t hesitate to <a href="/contact">get in touch</a> or <a href="https://www.linkedin.com/in/johnhelsby/" >connect on LinkedIn</a> if you have any comments or questions. Have a great rest of your day!</p>
